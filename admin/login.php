...
if (isset($_POST['btnLogin'])) {
    ...
    if ($email == '' OR $upass == '') {
        ...
        $user = new User();
        // Use the static function for user authentication
        ...
        if ($res == true) {
            ...
            if ($_SESSION['U_ROLE'] == 'Administrator') {
                ...
                redirect(web_root."admin/some_page.php");
            }
        } else {
            message("Account does not exist or invalid password! Please contact Administrator.", "error");
